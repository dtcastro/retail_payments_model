...
import numpy as np
import pandas as pd
from model3 import CashManagementModel3, get_evolution_instruments_payments#, initialize_observed_proportion_instruments_payments, initialize_purchases_distribution, initialize_observed_proportion_by_value
...
#                "observed_prop_debit": observed_prop_debit,
                "ratio_threshold_for_accepting": .10,
                "ratio_threshold_for_using": .10,
...
# batch_run = BatchRunner(CashManagementModel3,
...
results = batch_run(
    CashManagementModel3,
    parameters=params,
    iterations=1,
    max_steps=10,
    number_processes=1, #Set it to None to use all the available processors; no windows tem que ser 1
...
min_index = np.argmin(run_data['evolution_instruments_payments']) 
# print("min_index")
# print(min_index)
